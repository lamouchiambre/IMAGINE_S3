...
int main (int argc, char ** argv) {
	...
	glm::mat4 rotate = glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0, 0.0, 1.0));//glm::mat4(1.0f);//
	glm::mat4 scale = glm::scale(glm::mat4(1.0f), glm::vec3(0.5, 0.5, 0.5)); 
	glm::mat4 transformation = trans * rotate * scale; 
	...
	// glm::vec4 transformedVector = myMatrix;
    ...
    do{
		...
		glUniformMatrix4fv(TransformID, 1, GL_FALSE, &transformation[0][0]);
